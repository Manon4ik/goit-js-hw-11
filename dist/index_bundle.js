...
async function fetchData(keyWord, page = 1, offset = 20) {
  try {
    const response = await axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(URL + "&q=" + encodeURIComponent(keyWord) + "&page=" + page);
    console.log('Data:', response.data);

    //console.log(typeof(response.data.hits));

    const markup = response.data.hits.map(({
      webformatURL,
      tags,
      likes,
      views,
...
.search-form input:focus, .search-form input:active, .search-form input:focus-visible {
  border: none;
  box-shadow: none;
  outline: none;
}
...
.load-more:hover {
  ...
  opacity: 0.8;
  transition: all 0.5s ease;
}/*# sourceMappingURL=styles.css.map */`, "",{"version":3,"sources":["webpack://./css/styles.scss","webpack://./css/styles.css"],"names":[],"mappings":"AAAA;EACI,+CAAA;EACA,2BAAA;ACCJ;;ADEA;EACI,kBAAA;EACA,kBAAA;EACA,aAAA;EACA,SAAA;ACCJ;;ADEA;EACI,kBAAA;EACA,cAAA;EACA,MAAA;EACA,OAAA;EACA,WAAA;EACA,YAAA;EACA,0CAAA;ACCJ;ADCI;EACI,aAAA;ACCR;;ADGA;EACI,kBAAA;EACA,WAAA;EACA,YAAA;EACA,kBAAA;EACA,QAAA;EACA,SAAA;EACA,oCAAA;EACA,gCAAA;ACAJ;;ADGA;;EAEI,WAAA;EACA,sBAAA;EACA,kBAAA;EACA,UAAA;EACA,kBAAA;EACA,sBAAA;EACA,yCAAA;ACAJ;;ADGA;EACI,UAAA;EACA,sCAAA;EACA,qBAAA;ACAJ;;ADGA;EACI;IACI,uBAAA;ECAN;EDGE;IACI,yBAAA;ECDN;AACF;ADIA;EACI;IACI,4DAAA;YAAA,oDAAA;ECFN;EDKE;IACI,wEAAA;YAAA,gEAAA;ECHN;EDME;IAEI,iFAAA;YAAA,yEAAA;ECLN;AACF;ADQA;EACI,aAAA;EACA,uBAAA;EACA,yBAAA;EACA,aAAA;EACA,mBAAA;ACNJ;;ADSA;EACI,kBAAA;ACNJ;ADQI;EACI,YAAA;EACA,YAAA;EACA,sBAAA;ACNR;ADOQ;EACI,YAAA;EACA,gBAAA;EACA,aAAA;ACLZ;ADSI;EACI,kBAAA;EACA,YAAA;EACA,UAAA;EACA,SAAA;EACA,gBAAA;EACA,YAAA;EACA,WAAA;EACA,YAAA;EACA,MAAA;EACA,QAAA;ACPR;ADQQ;EACI,eAAA;ACNZ;;ADYA;EACI,aAAA;EACA,8BAAA;EACA,eAAA;ACTJ;;ADYA;EACI,cAAA;EACA,uBAAA;EACA,eAAA;EACA,mBAAA;EAGA,+CAAA;ACTJ;ADWI;EACI,kBAAA;EACA,mBAAA;ACTR;ADWQ;EACI,kBAAA;EACA,2BAAA;KAAA,wBAAA;EACA,oBAAA;KAAA,iBAAA;EACA,YAAA;EACA,WAAA;EACA,OAAA;ACTZ;;ADgBA;EACI,aAAA;EACA,6BAAA;ACbJ;;ADgBA;EACI,kBAAA;ACbJ;;ADgBA;EACI,aAAA;ACbJ;;ADgBA;EACI,iBAAA;EACA,kBAAA;EACA,aAAA;EACA,aAAA;EACA,WAAA;EACA,yBAAA;EACA,gBAAA;EACA,YAAA;EACA,yBAAA;ACbJ;ADcI;EACI,eAAA;EACA,YAAA;EACA,yBAAA;ACZR,CAAA,qCAAA","sourceRoot":""}]);
// Exports
...
/*!********************!*\
  ...
  \********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _fetch_images_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fetch-images.js */ "./js/fetch-images.js");
...
btnSearch.addEventListener("click", function (e) {
  ...
  (0,_fetch_images_js__WEBPACK_IMPORTED_MODULE_0__.fetchData)(inputSearch.value);
  console.log('submit');
});
btnLoadMore.addEventListener("click", function (e) {
  ...
  (0,_fetch_images_js__WEBPACK_IMPORTED_MODULE_0__.fetchData)(inputSearch, page, offset);
